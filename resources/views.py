...
from resources.models import ResourceType, PersonalResource
from resources.forms import ResourceForm, PersonalResourceForm
from courses.models import TopicResource, Topic
...
def PersonalResourceCreateViewOC(request):
    ...
    try:
        r = PersonalResource.objects.get(url=url, person=person)
    except Resource.DoesNotExist:
            r = PersonalResource.objects.create(url=url)
            r.save()
...
class PersonalResourceEditView(UpdateView):
    context_object_name = 'resource'
    template_name = 'resources/personalresource_edit.html'
    form_class = PersonalResourceForm
    model = PersonalResource
...
class PersonalResourceListView(ListView):
    ...
    model = PersonalResource
    template_name = 'resources/personalresource_list.html'
...
class ResourceTagDetailView(DetailView):
    ...
    model = Tag
    template_name = 'resources/resource_tag_detail.html'
...
class ResourceTagListView(ListView):
    ...
    model = Tag
    template_name = 'resources/resource_tag_list.html'
