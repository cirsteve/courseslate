...
from resources.views import PersonalResourceCreateView, PersonalResourceCreateViewOC, PersonalResourceEditView, PersonalResourceDetailView, PersonalResourceListView
