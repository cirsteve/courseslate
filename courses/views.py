...
class HomeView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        resource_list = PersonalResource.objects.all().order_by('-added')[:7]
...
class UserTopicListView(ListView):
    context_object_name = 'topic_list'
    template_name = 'courses/user_topic_list.html'
...
class TopicCreateView(CreateView):
    ...
    model = Topic
    template_name = 'courses/topic_create.html'
        
    def form_valid(self, form):
        tags = form.cleaned_data['tags']
        self.object = form.save(commit=False)
        print 'form val ', form, self.object, tags
...
class TopicResourcesCreateView(CreateView):
    ...
    model = TopicResource
    template_name = 'courses/topicresources_create.html'
    success_url = '../..'
...
class TopicResourcesDetailView(DetailView):
    ...
    template_name = 'courses/topicresources_detail.html'
...
class TopicResourceEditView(UpdateView):
    ...
    model = TopicResource
    form_class = TopicResourceForm
    template_name = 'courses/topicresources_edit.html'
    success_url = '../../..'
...
class TopicResourcesListView(ListView):
    ...
    template_name = 'courses/topicresources_list.html'
...
class TopicResourceDeleteView(DeleteView):
    context_object_name = 'topicresource'
    template_name = 'courses/topicresource_delete.html'
    model = TopicResource
    success_url = '../../..'
...
class UpdatesListView(ListView):
    ...
    template_name = 'courses/updates_list.html'
...
class UpatesDetailView(DetailView):
	...
	template_name = 'courses/updates_detail.html'
	
	
class UpdatesCreateView(CreateView):
    form_class = UpdatesForm
    model = Update
    template_name = 'courses/updates_create.html'
    success_url = '../..'
...
class UpdateEditView(UpdateView):
    ...
    model = Update
    form_class = UpdatesForm
    template_name = 'courses/updates_edit.html'
    success_url = '../../..'
...
class UpdateDeleteView(DeleteView):
    context_object_name = 'update'
    template_name = 'courses/update_delete.html'
    model = Update
    success_url = '../../..'
...
class  CategoryCreateView(CreateView):
	...
	model = Category
	template_name = 'courses/category_create.html'
	
	
class TopicTagsListView(ListView):
    context_object_name = 'tag_list'
    template_name = 'courses/topic_tag_list.html'
...
class TopicTagsDetailView(DetailView):
    ...
    model = Tag
    template_name = 'courses/topic_tag_detail.html'
