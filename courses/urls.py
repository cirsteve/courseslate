...
from courses.views import UserTopicListView, TopicListView, TopicDetailView, TopicCreateView, TopicEditView
from courses.views import TopicResourcesCreateView, TopicResourcesListView, TopicResourceEditView, TopicResourceDeleteView
from courses.views import UpdatesListView, UpdatesCreateView, UpdateEditView, UpdateDeleteView
#from courses.views import CategoryCreateView, CategoryDetailView, CategoryListView
#from courses.views import TopicTagsListView, TopicTagsDetailView
from courses.views import update_create_xhr, update_edit_xhr, tr_create_xhr, tr_edit_xhr
